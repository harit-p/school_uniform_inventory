          ...
          <table className="min-w-full divide-y divide-slate-200">
            <thead className="bg-slate-50">
              <tr>
                ...
                <th className="px-4 py-2 text-right text-xs font-medium uppercase text-slate-600">Amount</th>
              ...
              {bills.length === 0 ? (
                ...
                bills.map((b) => (
                  <tr key={b._id} className="hover:bg-slate-50">
                    ...
                    <td className="px-4 py-2 text-right font-medium">₹{(b.finalAmount || 0).toFixed(2)}</td>
